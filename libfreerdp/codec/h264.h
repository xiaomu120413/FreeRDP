...
#define H264_OHOS_AVCODEC_NO_OUTPUT_RC (-3301)
	...
	struct S_H264_CONTEXT
	{
		...
		BOOL ohosAvcodecBufferModeAllowed;
	...
	FREERDP_LOCAL BOOL h264_context_set_ohos_avcodec_buffer_mode_allowed(H264_CONTEXT* h264,
	                                                                     BOOL allowed);
